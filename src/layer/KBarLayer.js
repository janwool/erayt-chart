...
export default class KBarLayer extends BaseLayer {
    constructor(canvas, options) {
        ...
        this.barNum = options.barNum || 60;
        this.data = options.data || [];
        this.redHollow = options.redHollow || false;
        this.greenHollow = options.greenHollow || false;
        this.redColor = options.redColor || '#EE1100';
        this.greenColor = options.greenColor || '#00C000';
    }
    ...
    make() {
        ...
        for (let i = barStart; i <= barEnd; i++) {
            ...
            bar.setPosition( (i - barStart) * barWidth, this.position.y);
            this.addChild(bar);
        }
